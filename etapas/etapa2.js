...
registerView('e2', {
  ...
  render(c) {
    ...
    <div class="grid-2">
      ...
      ${panel({ tag: 'Q2', q: '¿Valor total de mercado por región?', canvas: 'e2b', answer: '<b>Respuesta:</b> Europa concentra la mayor parte del valor de mercado mundial.' })}
      ...
      ${panel({ tag: 'Q4', q: '¿Margen (Valor − Salario) por club?', canvas: 'e2d', answer: '<b>Respuesta:</b> mayor margen = activos valiosos sin masa salarial proporcional.' })}
